...
OBJET = $(addprefix $(OBJDIR)/, \
        Base58.o IntGroup.o Random.o Timer.o Int.o \
        IntMod.o Point.o SECP256K1.o Vanity.o GPU/GPUGenerate.o \
        hash/ripemd160.o hash/sha256.o hash/sha512.o \
        hash/ripemd160_sse.o hash/sha256_sse.o \
        GPU/GPUEngine.o Bech32.o Wildcard.o main.o)
...
OBJET = $(addprefix $(OBJDIR)/, \
        ...
        IntMod.o Point.o SECP256K1.o Vanity.o GPU/GPUGenerate.o \
        hash/ripemd160.o hash/sha256.o hash/sha512.o \
        hash/ripemd160_sse.o hash/sha256_sse.o Bech32.o Wildcard.o main.o)
...
$(OBJDIR)/main.o: main.cu
	$(NVCC) -arch=sm_$(ccap) -O3 -o $(OBJDIR)/main.o -c main.cu
